    ...
    <section className=" w-full container mx-auto py-10">
      ...
      {!isLoading ? (
        !isError ? (
          ...
          }) : <p className="col-span-full text-center h-[50vh] flex gap-2 items-center justify-center">Catagory does not exist! Select from <span className="font-bold">Catagory menu</span> </p>
        ) : (
          <p>{error.message}</p>
        )
      ) : (
